...
class Video(models.Model):
    ...
    width = models.IntegerField("Ширина:", max_length=6, blank=True)
    height = models.IntegerField("Высота:", max_length=6, blank=True)
    resolution = models.CharField("Разрешение:", max_length=12, blank=True)
    format = models.CharField("Формат:", max_length=32, blank=True)
    filesize = models.CharField("Размер файла:", max_length=256, blank=True)
    ...
    framerate = models.FloatField("Частота кадров:", max_length=255, blank=True)
    colorspace = models.CharField("Цветовое пространство:", max_length=32, blank=True)
    bitdepth = models.IntegerField("Глубина цвета:", max_length=4, blank=True)
    ...
    asamplingrate = models.IntegerField("Частота дискретизации:", max_length=8, blank=True)
    abitdepth = models.IntegerField("Глубина дискретизации:", max_length=8, blank=True)
